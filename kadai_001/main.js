...
const typingcount =document.getElementById('typing-count'); //タイピングカウント数表示のHTMLを取得
...
const keyPress = e => {
  ...
  typingcount.textContent = score; //HTML要素取得した typingcount に score数を代入する。
...
typingcount.style.display = 'none';    //タイピング数を非表示にしておく
